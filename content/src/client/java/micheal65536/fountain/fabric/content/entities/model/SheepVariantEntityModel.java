...
public class SheepVariantEntityModel<T extends SheepEntity> extends SheepEntityModel<T>
{
	public static final EntityModelLayer ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier("fountain", "sheep_v2"), "main");

	public static void register()
	{
		EntityModelLayerRegistry.registerModelLayer(ENTITY_MODEL_LAYER, SheepVariantEntityModel::getTexturedModelData);
	}

	public SheepVariantEntityModel(ModelPart root)
	{
		super(root);
	}
	...
	public static TexturedModelData getTexturedModelData()
	{
		...
		root.addChild(EntityModelPartNames.HEAD,
				ModelPartBuilder.create()
						.uv(0, 0).cuboid(-3.0f, -4.0f, -6.0f, 6.0f, 6.0f, 8.0f),
				ModelTransform.pivot(0.0f, 6.0f, -8.0f));

		root.addChild(EntityModelPartNames.BODY,
				ModelPartBuilder.create()
						.uv(36, 20).cuboid(-4.0f, -10.0f, -7.0f, 8.0f, 16.0f, 6.0f),

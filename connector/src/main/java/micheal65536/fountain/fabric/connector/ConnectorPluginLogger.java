...
public final class ConnectorPluginLogger implements Logger
{
	...
	public ConnectorPluginLogger(@NotNull org.slf4j.Logger logger)
	{
		this.logger = logger;
	}
	...
	{
		this.logger.warn(throwable.toString());
	}
	...
	{
		this.logger.info(throwable.toString());
	}
	...
	{
		this.logger.debug(throwable.toString());
	}
}